  ...
  return (
    <header className="relative z-30 w-full">
      <div className="bg-copper text-white">
        <div className="mx-auto flex max-w-[1425px] items-center justify-between gap-6 px-[25px] py-2">
      ...
      <div className="bg-white">
        <div className="mx-auto flex max-w-[1425px] items-center justify-between gap-6 px-[25px] py-4">
          <Logo />
